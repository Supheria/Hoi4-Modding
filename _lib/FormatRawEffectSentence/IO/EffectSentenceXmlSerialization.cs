...
public class EffectSentenceXmlSerialization : EffectSentenceStringSerialization, IXmlSerialization<EffectSentence>
{
    ...
    public void ReadXml(XmlReader reader)
    {
        ...
        Source.SubSentences.ReadXmlCollection(reader, LocalNameSub, new EffectSentenceXmlSerialization());
    }
    ...
    public void WriteXml(XmlWriter writer)
    {
        ...
        Source.SubSentences.WriteXmlCollection(writer, LocalNameSub, new EffectSentenceXmlSerialization());
    }
}